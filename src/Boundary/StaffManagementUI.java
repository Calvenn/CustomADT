 ...
 * @author tanjixian
 */
public class StaffManagementUI extends javax.swing.JFrame {
    ...
    // Constructor
    public StaffManagementUI(DoctorManager docManager, StaffManager staffManager) {
        initComponents();
   ...
   //FUNCTIONS 
    ...
    private void initComponents() {
        ...
        userImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/user.png"))); // NOI18N
        userImage.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        userImage.setMaximumSize(new java.awt.Dimension(24, 22));
        userImage.setMinimumSize(new java.awt.Dimension(24, 22));
        userImage.setName(""); // NOI18N
        userImage.setPreferredSize(new java.awt.Dimension(24, 22));
        ...
        Lock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/padlock.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(userImage, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
            ...
            if(position.trim().equalsIgnoreCase("ADMIN")){
                if(staffManager.findStaff(id) == null) {
                    ...
                    if(id.equalsIgnoreCase(staffManager.findStaff(id).getID()) && password.equalsIgnoreCase(staffManager.findStaff(id).getPassword())){
                        ...
                        login = position; // A = ADMIN
                        return true;
                    }
                }
            } else if (position.trim().equalsIgnoreCase("NURSE")){
                if(staffManager.findStaff(id) == null){
                    userGuide.setText("ID not found!");
                    userGuide.setForeground(Color.RED);
                    return false;
                    ...
                    if(id.equalsIgnoreCase(staffManager.findStaff(id).getID()) && password.equalsIgnoreCase(staffManager.findStaff(id).getPassword())){
                        userGuide.setText("Login Successful!");
                        userGuide.setForeground(Color.GREEN);
                        login = position; // N = Nurse
                        return true;
                    }
                }
            } else if (position.trim().equalsIgnoreCase("DOCTOR")){
                if(docManager.findDoctor(id) == null){
                    userGuide.setText("ID not found!");
                    userGuide.setForeground(Color.RED);
                    return false;
                } else {
                    if(id.equalsIgnoreCase(docManager.findDoctor(id).getID()) && password.equalsIgnoreCase(docManager.findDoctor(id).getPassword())){
                        userGuide.setText("Login Successful!");
                        userGuide.setForeground(Color.GREEN);
                        login = position; // D = Doctor
                        return true;
                    }
                }
            }
        } else {
            userGuide.setText("User ID must be in the correct format E.g. D001.");
            userGuide.setForeground(Color.RED);
            return false;
            }
            return false;
   ...
   // HELPER FUNCTION
    ...
    public void staffLogin(){
        switch(login){
            case "ADMIN" -> adminMenu(currID);
            case "NURSE" -> nurseMenu(currID);
            case "DOCTOR" -> doctorMenu(currID);
        }           
    }
    
    // Check Correct ID format using REGEX
    private boolean idFormat(String id){
        return id.matches("^[ADN]\\d{3}$");
    }
   ...
   // MENU
    ...
    public void adminMenu(String userID){
        while (choice < 1 && choice > 5){ // Repeat the step if the user input invalid choice
            printTitle("ADMIN", staffManager.findStaff(userID).getName());
    ...
    // Menu for DOCTOR
    public void doctorMenu(String userID){
        while (choice < 1 && choice > 5){ // Repeat the step if the user input invalid choice
    ...
    // Menu for NURSE
        public void nurseMenu(String userID){
        while (choice < 1 && choice > 5){ // Repeat the step if the user input invalid choice
