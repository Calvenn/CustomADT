...
public class StaffLoginTest {
    ...
    // Constructor
    public StaffLoginTest(QueueManager queueManager, StaffManager staffManager, ConsultationUI consultUI, TreatmentUI treatmentUI, TreatmentApptUI treatmentApptUI, PharmacyUI pharUI, PatientManagementUI patientUI, StaffManagementUI staffUI, PaymentUI payUI) {
